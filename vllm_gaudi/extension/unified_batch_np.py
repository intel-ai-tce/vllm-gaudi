...
from vllm_gaudi.extension.unified import HPUUnifiedAttentionMetadata, UnifiedBatch, to_hpu
import math
import functools
import itertools
...
def hpu_tensor(tensor: np.ndarray, shape: tuple, pad_value: Union[int, float], dtype: torch.dtype) -> torch.tensor:
